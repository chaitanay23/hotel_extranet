    ...
    <div class="row mt-4">
        <div class="col-xs-6 col-sm-6 col-md-6">
            <div class="form-group">
                ...
                {!! Form::select('user_role_define',['1' => 'Biddr','2' => 'Hotel','3'=>'Revenue Manager','4'=>'Channel Manager'],null,['placeholder' => 'Select user type...','class' => 'form-control','id' => 'userType','required']) !!}
            </div>
        </div>
