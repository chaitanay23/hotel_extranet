...
<div class="row">   
    ...
    <div class="col-xs-6 col-sm-6 col-md-6">
        <div class="form-group">
            ...
            {!! Form::select('user_role_define',['1' => 'MagicSpree','2' => 'Hotel','3'=>'Revenue Manager','4'=>'Channel Manager'],null,['placeholder' => 'Select user type...','class' => 'form-control','required']) !!}
        </div>
    </div>
...
<script >
    jQuery(document).ready(function($) {
        ...
        $.ajax({
            ...
            method:"POST",
            data:{_token:_token,type:type,super_user_id:super_user},
