			...
			<div class="hotel-deal">
				<div class="dealimg text-center">
					...
					<div class="deal-termcondition">
						<p>By Switching on the offer, you agree to the Terms & Conditions of Biddr</p>
					</div>
					...
					if (check == '1') {
						$.ajax({
							...
							success: function(data) {
								$(tag).children().children().val('0');
							}
						})
						$(tag).parent().parent().parent().parent().next().css("background", "linear-gradient(to right, #d74142 0%, #eb6e29 100%)");
					} else {
						$.ajax({
							...
							success: function(data) {
								$(tag).children().children().val('1');
							}
						})
						$(tag).parent().parent().parent().parent().next().css("background", "linear-gradient(to right, #9bc256 0%, #6ad044 100%)");
					}
