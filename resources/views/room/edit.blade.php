...
<div class="form form-padding">
	<div class="row mt-4">
		...
		<div class="col-md-6 col-xs-6 col-sm-6">	
			<div class="form-group">
				<strong>Extra Adult Charges:</strong>
				{{ Form::select('extra_adult_cost_collection',[ 0=>'Pay at Hotel', 1=>'Pay Online'], null,['placeholder' => 'Select Payee','class' => 'form-control','required'])}}
			</div>
		</div>
