...
@endif
{!! Form::model($room, ['method' => 'POST','route' => ['room.store'],'enctype' => 'multipart/form-data']) !!}
	...
	<div class="row mt-4">
	    ...
	    <div class="col-xs-12 col-sm-12 col-md-12">
	        <div class="form-group">
	            ...
	            {!! Form::text('custom_category', '', array('placeholder' => 'Room category name','class' => 'form-control','required')) !!}
	        </div>
    	</div>
