    ...
    public function showBookings(Request $request)
    {
        ...
        if($logged_in_user->user_role_define == 1 and $logged_in_user->user_level == 1)
        {
            ...
            if($search==1)
            {
                ...
                if($fromdate !='' || $todate !='') {
                $booking = Booking::whereBetween('created_at',[$fromdate,$todate])->paginate(15);
        

                }else   $booking =Booking::paginate(15);
            ...
            elseif($search==2)
            {
                echo $search;
                if($fromdate !='' || $todate !='') {
                    $booking = Booking::whereBetween('check_in_time',[$fromdate,$todate])->paginate(15);
            ...
            elseif($search==3)
            {
                ...
                if($fromdate !='' || $todate !='') {
                    $booking = Booking::whereBetween('check_out_time',[$fromdate,$todate])->paginate(15);
            
        
                    }else   $booking =Booking::paginate(15);  echo $search;
                ...
                if($id!='')
                {
                    $booking = Booking::where('booking_code',$id)->paginate(15);
                }
                else 
           ...
           //check this i think its wrong
            ...
            if($search==1)
            {
                ...
                if($fromdate !='' || $todate !='') {
                    ...
                    $booking= DB::table('bookings')->leftjoin('hotels', 'hotels.id', '=', 'bookings.hotel_id')->leftjoin('hoteldetails', 'hoteldetails.id', '=', 'bookings.hoteldetail_id')->leftjoin('users', 'users.id', '=', 'bookings.user_id')->where('hotels.rm_user_id','=',$user_id)->whereBetween('bookings.created_at',[$fromdate,$todate])->paginate(15);

                }else                $booking= DB::table('bookings')->leftjoin('hotels', 'hotels.id', '=', 'bookings.hotel_id')->leftjoin('hoteldetails', 'hoteldetails.id', '=', 'bookings.hoteldetail_id')->leftjoin('users', 'users.id', '=', 'bookings.user_id')->where('hotels.rm_user_id','=',$user_id)->paginate(15);
                ...
                elseif($search==2)
                {
                    echo $search;
                    if($fromdate !='' || $todate !='') {
                        $booking= DB::table('bookings')->leftjoin('hotels', 'hotels.id', '=', 'bookings.hotel_id')->leftjoin('hoteldetails', 'hoteldetails.id', '=', 'bookings.hoteldetail_id')->leftjoin('users', 'users.id', '=', 'bookings.user_id')->where('hotels.rm_user_id','=',$user_id)->whereBetween('bookings.check_out_time',[$fromdate,$todate])->paginate(15);
                ...
                elseif($search==3)
                {
                    ...
                    if($fromdate !='' || $todate !='') {
                        $booking= DB::table('bookings')->leftjoin('hotels', 'hotels.id', '=', 'bookings.hotel_id')->leftjoin('hoteldetails', 'hoteldetails.id', '=', 'bookings.hoteldetail_id')->leftjoin('users', 'users.id', '=', 'bookings.user_id')->where('hotels.rm_user_id','=',$user_id)->whereBetween('bookings.check_in_time',[$fromdate,$todate])->paginate(15);
                ...
                if($id!='')
                {
                    $booking= DB::table('bookings')->leftjoin('hotels', 'hotels.id', '=', 'bookings.hotel_id')->leftjoin('hoteldetails', 'hoteldetails.id', '=', 'bookings.hoteldetail_id')->leftjoin('users', 'users.id', '=', 'bookings.user_id')->where('hotels.rm_user_id','=',$user_id)->where('bookings.booking_code',$id)->paginate(15);

                }
                else 
                $booking= DB::table('bookings')->leftjoin('hotels', 'hotels.id', '=', 'bookings.hotel_id')->leftjoin('hoteldetails', 'hoteldetails.id', '=', 'bookings.hoteldetail_id')->leftjoin('users', 'users.id', '=', 'bookings.user_id')->where('hotels.rm_user_id','=',$user_id)->paginate(15);
...
//again wrong code for $search
    ...
    public function NotBooked(Request $request)
    {
        ...
        $todate1 = date_format($date2,"Y-m-d");
        if($fromdate !='' || $todate !='') {
        $booking = Successfullbid::whereBetween('created_at',[$fromdate,$todate])->where('booking_status',0)->paginate(15);
       

        }  else {
        $booking = Successfullbid::paginate(15);
        }
        $counter =count($booking);
    ...
    public function Booked(Request $request)
    {
        ...
        $todate1 = date_format($date2,"Y-m-d");
        if($fromdate !='' || $todate !='') {
        $booking = Successfullbid::whereBetween('created_at',[$fromdate,$todate])->where('booking_status',1)->paginate(15);
    ...
    public function Unsuccessful(Request $request)
    {
        ...
        $todate1 = date_format($date2,"Y-m-d");
        if($fromdate !='' || $todate !='') {
        $booking = Bidcounter::whereBetween('created_at',[$fromdate,$todate])->paginate(15);
       

        }  else {
        $booking = Bidcounter::paginate(15);
        }
        $counter =count($booking);
    ...
    public function showSales(Request $request)
    {
        ...
        elseif($logged_in_user->user_role_define == 2 and $logged_in_user->user_level != 1)
        {
            ...
            if($fromdate !='' || $todate !='') {
                $booking= DB::table('bookings')->leftjoin('hotels', 'hotels.id', '=', 'bookings.hotel_id')->leftjoin('hoteldetails', 'hoteldetails.id', '=', 'bookings.hoteldetail_id')->leftjoin('users', 'users.id', '=', 'bookings.user_id')->where('hoteldetails.user_id','=',$user_id)->wherebetween('bookings.created_at',[$fromdate,$todate])->paginate(15);
        
                }  else {
                    $booking= DB::table('bookings')->leftjoin('hotels', 'hotels.id', '=', 'bookings.hotel_id')->leftjoin('hoteldetails', 'hoteldetails.id', '=', 'bookings.hoteldetail_id')->leftjoin('users', 'users.id', '=', 'bookings.user_id')->where('hoteldetails.user_id','=',$user_id)->paginate(15);
                }
                $counter =count($booking);
    ...
    public function Negotiable(Request $request)
    {
        ...
        $todate1 = date_format($date2,"Y-m-d");
        if($fromdate !='' || $todate !='') {
        $booking = Negotiable::whereBetween('created_at',[$fromdate,$todate])->paginate(15);
       

        }  else {
        $booking = Negotiable::paginate(15);
        }
        $counter =count($booking);
