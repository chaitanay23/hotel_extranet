...
class HotelController extends Controller
{
    ...
    public function store(Request $request)
    {
        $valid_message = [
            ...
            'pictures.max' => 'Hotel images is more than 2 MB',
            ];
    ...
    public function edit($id)
    {
        ...
        return view('hotel.edit',compact('hotel','hotel_type','cities','fac','pre_facility','rm','revenue'));
    }
