...
class channelManagerController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('channel.edit',compact('channel','hotel'));
    }
    ...
    public function destroy(Request $request,$id)
    {
        ...
        AuditLog::auditLogs($request,$id);
        return redirect()->route('channel.index')->with('Success','Channel manager deleted successfully');
    }
}
